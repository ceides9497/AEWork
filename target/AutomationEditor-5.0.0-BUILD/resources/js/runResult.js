...
var runResult_App = angular.module('runResult_App',['scrollable-table'])
...
.controller('runResultCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = runResult_txt;
