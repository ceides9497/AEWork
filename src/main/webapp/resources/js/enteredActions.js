...
var enteredActions_App = angular.module('enteredActions_App',['scrollable-table'])
...
.controller('enteredActionsCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = enteredActions_txt;
