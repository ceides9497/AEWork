...
var keyPress_App = angular.module('keyPress_App',['scrollable-table'])
...
.controller('keyPressCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = keyPress_txt;
});