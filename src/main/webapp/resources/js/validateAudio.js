...
var validateAudio_App = angular.module('validateAudio_App',['scrollable-table'])
...
.controller('validateAudioCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = validateAudio_txt;
