...
var actionButtons_App = angular.module('actionButtons_App',['scrollable-table'])
...
.controller('actionButtonsCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = actionButtons_txt;
