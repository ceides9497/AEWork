<link rel="stylesheet" href="<c:url value="/resources/css/validate.css"/>"/>

<div id="validateHide" class="validateHide" onClick="showValidate()">
<p class="textValidate">Validate</p>
<p class="dropdown" style="float: right;margin-top: 7px;margin-right: 45px"></p>
</div>

<div id="validateBlock" class ="validateBlock">
<form id="validateForm">
  <div ng-app="validate_App" ng-cloak>
	<div class="validate_inner_table">
	  <div ng-controller="validateCtrl" class="validate_container">	
		<div id ="validate">
